...
First we take all values in the height and weight columns and replace them with N/A value
...
userInfo <- dplyr::tibble(id=users$id, height=users$height, weight=users$weight, city=users$city, country=users$country, year_started=users$started, occupation=users$occupation, birthday=users$birth)
```
#Early Exploration
