...
Download data from https://www.kaggle.com/dcohen21/8anu-climbing-logbook
```{r}
...
Finally some things I would like to look into are things like the relationship between size and climbing ability, the relationship between location and climbing ability.  